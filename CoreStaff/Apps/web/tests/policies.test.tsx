...
test('labor create posts the full §30B.1 DTO and refetches', async () => {
  ...
  await setInput('labor-policy-normalDailyMinutes', '540');
  await setInput('labor-policy-normalWeeklyMinutes', '3000');
  await setInput('labor-policy-maxCombinedDailyMinutes', '780');
  await setInput('labor-policy-maxMonthlyOvertimeMinutes', '3000');
  await setInput('labor-policy-maxAnnualOvertimeMinutes', '22000');
  await setInput('labor-policy-exceptionalAnnualOvertimeMinutes', '26000');
