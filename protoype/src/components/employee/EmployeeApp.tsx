...
export const EmployeeApp: React.FC<Props> = ({ scenario, onOpenPolicy, onOpenAdjustment, onOpenClarification }) => {
  ...
  const params = (photoUrl?: string) => ({ workMode: scenario.workMode, networkValid: scenario.method === 'NETWORK', gpsDistance: scenario.method === 'GPS' ? 24 : undefined, gpsAccuracy: scenario.method === 'GPS' ? 16 : undefined, photoUrl });
  const act = () => {
